    ...
    <section className='py-16'>
      <div className='container mx-auto px-4 text-start'>
        ...
        <Link
          ...
          className='relative inline-flex items-center justify-center uppercase text-white font-medium py-2 px-4 text-sm md:text-base lg:text-lg w-full transition duration-300 bg-primary rounded hover:shadow-lg hover:translate-y-[-2px]'
