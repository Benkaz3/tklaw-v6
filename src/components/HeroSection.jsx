      ...
      <div className='relative z-10 max-w-2xl text-center px-6 md:px-12 lg:px-16 transition duration-300 fade-in'>
        ...
        <div className='flex flex-col md:flex-row justify-center gap-4'>
          ...
          <Link
            ...
            className='relative inline-flex items-center justify-center uppercase text-white font-medium py-3 px-6 text-lg transition duration-300 bg-primary rounded shadow-md hover:shadow-lg transform hover:translate-y-[-2px]'
